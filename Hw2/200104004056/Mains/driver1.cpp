...
int main(){
	...
	unit1.setRotation('r');
	unit1.setHorizontal(10);
	unit1.setVertical(20);
	cout<<unit1.getVertical()<<endl;
	cout<<unit1.getVertical()<<endl;
	...
	cout<<"BUTTTT !!!"<<endl;
	cout<<"Since there is no background for canFit function to work with, I can not show this function with 1 or 2 tetromino"<<endl;
	cout<<"But I do not think this is important since this is a task of previvous homewrok. It is working on previous homework"<<endl;
	cout<<"I did not think that will be necessary to show that this function is working properly on this homework.As I said, there is no background"<<endl;
